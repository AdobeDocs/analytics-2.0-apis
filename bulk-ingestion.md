...
Sample Call
```curl -X POST -F file=@/tmp/newfile_1489183489.gz -H "x-adobe-vgid:prod-18" -H "x-adobe-fileid:a00ce559-2489-497d-9b52-acfa33fe692b" -H "Authorization: Bearer <IMS_ACCESS_TOKEN>" "https://<SDC_HOST>/fileingest/file?error-threshold-percentage=1.5" ```
...
| Sample Call | curl -X POST -H "Authorization: Bearer <IMS_ACCESS_TOKEN>" -F file=@/some/path/file.gz "https://<SDC_HOST>/fileingest/file/validate" |
...
--|--|--
1.0.0| 5/1/20| General Availability version of the BIA API released.  First public documentation published.
