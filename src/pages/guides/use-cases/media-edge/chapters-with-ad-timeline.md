...
In contrast to the [Buffer state and a pause Media Edge use case](https://experienceleague.adobe.com), this example presents a differing offset playhead position in the timeline.
