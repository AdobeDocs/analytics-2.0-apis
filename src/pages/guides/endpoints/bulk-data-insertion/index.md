...
| | Bulk Data Insertion API (BDIA) | [Data Insertion API (DIA)](../data-insertion/) |
|---|---|---|
...
* You do not plan to upload more than 1 file per second, nor send files with very small row counts. If these stipulations are not possible, consider using the [Data Insertion API](../data-insertion/) instead.
