...
In addition to our managed throttling system, we also enforce a hard cap of 10 requests/sec for all API clients. If you are approaching this limit, you should send larger files to reduce file volume.
